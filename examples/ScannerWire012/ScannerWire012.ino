...
void loop() {
  ...
  for (address = 1; address < 127; address++) {
    ...
    if (error == 0) {
      Serial.print(F("Wire  Device found at address 0x"));
      if (address < 16) {
        Serial.print("0");
      }
      ...
      Serial.print(F("Wire Unknown error at address 0x"));
      if (address < 16) {
        Serial.print("0");
      }
    ...
    if (error == 0) {
      Serial.print(F("Wire1 Device found at address 0x"));
      if (address < 16) {
        Serial.print("0");
      }
      Serial.print(address, HEX);
      ...
      Serial.print(F("Wire1 Unknown error at address 0x"));
      if (address < 16) {
        Serial.print("0");
      }
      Serial.println(address, HEX);
    ...
    if (error == 0) {
      Serial.print(F("Wire2 Device found at address 0x"));
      if (address < 16) {
        Serial.print("0");
      }
      Serial.print(address, HEX);
      ...
      Serial.print(F("Wire2 Unknown error at address 0x"));
      if (address < 16) {
        Serial.print("0");
      }
      Serial.println(address, HEX);
...
void printKnownChips(byte address)
{
  ...
  switch (address) {
    ...
    case 0x7C: Serial.print(F("FRAM_x")); break;
